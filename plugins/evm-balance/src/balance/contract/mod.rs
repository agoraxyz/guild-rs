...
mod test {
    ...
    async fn rpc_get_erc20_decimals() {
        ...
        let decimals_1 = get_erc20_decimals(client.clone(), RPC_URL, token_1)
            .await
            .unwrap();
        let decimals_2 = get_erc20_decimals(client.clone(), RPC_URL, token_2)
            .await
            .unwrap();
        let decimals_3 = get_erc20_decimals(client.clone(), RPC_URL, token_3)
            .await
            .unwrap();
